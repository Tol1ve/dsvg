...
def process_image(input_path, output_path):
    ...
    # 反转 X 和 Y 轴
    img_data_flipped = np.flip(img_data, axis=(0, 1))  # Flip X and Y axes
...
if __name__ == "__main__":
    # 输入和输出文件夹路径
    input_folder = '/home/lvyao/git/dataset/CRL_FetalBrainAtlas_2017v3'  # 替换为实际的输入文件夹路径
    output_folder = '/home/lvyao/git/dataset/CRL_reaffined'  # 替换为实际的输出文件夹路径
